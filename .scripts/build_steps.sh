...
# automatically.
/usr/bin/sudo -n yum install -y mesa-libGL-devel mesa-dri-drivers libselinux libXdamage libXxf86vm libXext libX11 libXrender libXdmcp libXcursor libxcb libXau
)
